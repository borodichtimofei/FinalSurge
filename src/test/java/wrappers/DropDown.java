...
public class DropDown {
    ...
    public static final String LOCATOR_REGISTRATION = "//label[text()='%s']/../select",
            LOCATOR_WORKOUT_BASIC = "//label[text()='%s']//../following-sibling::select",
            LOCATOR_WORKOUT_SECONDARY = "(//label[text()='%s']//../following-sibling::select)[2]",
            LOCATOR_CALCULATOR_TYPE = "//label[text() = '%s:']/..//select[1]",
            LOCATOR_CALCULATOR_RACE = "//label[text() = '%s:']/..//select[2]";
